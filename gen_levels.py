...
def build_level(name, size, file_name, num_enemies=4, num_pillars=0, num_torches=0, num_chests=1, add_interact_altar=False):
    ...
    lines.append('')
    lines.append('[sub_resource type="BoxShape3D" id="BoxShape3D_wall_NS"]')
    lines.append(f'size = Vector3({floor_size}, 4.0, 1.0)')
    lines.append('')
    lines.append('[sub_resource type="BoxShape3D" id="BoxShape3D_wall_EW"]')
    lines.append(f'size = Vector3(1.0, 4.0, {floor_size})')
    lines.append('')
    ...
    lines.append('; --- Invisible Boundary Collisions ---')
    lines.append('[node name="BoundaryCollisions" type="StaticBody3D" parent="Walls"]')
    lines.append('[node name="Shape_N" type="CollisionShape3D" parent="Walls/BoundaryCollisions"]')
    lines.append(f'transform = Transform3D(1,0,0, 0,1,0, 0,0,1, {center},2.0,{last_pos})')
    lines.append('shape = SubResource("BoxShape3D_wall_NS")')
    lines.append('[node name="Shape_S" type="CollisionShape3D" parent="Walls/BoundaryCollisions"]')
    lines.append(f'transform = Transform3D(1,0,0, 0,1,0, 0,0,1, {center},2.0,-0.5)')
    lines.append('shape = SubResource("BoxShape3D_wall_NS")')
    lines.append('[node name="Shape_W" type="CollisionShape3D" parent="Walls/BoundaryCollisions"]')
    lines.append(f'transform = Transform3D(1,0,0, 0,1,0, 0,0,1, -0.5,2.0,{center-0.25})')
    lines.append('shape = SubResource("BoxShape3D_wall_EW")')
    lines.append('[node name="Shape_E" type="CollisionShape3D" parent="Walls/BoundaryCollisions"]')
    lines.append(f'transform = Transform3D(1,0,0, 0,1,0, 0,0,1, {last_pos},2.0,{center-0.25})')
    lines.append('shape = SubResource("BoxShape3D_wall_EW")')
    lines.append('')
